  ...
  return (
    <>
      <aside className="w-[20vw]">
        <div className="border-r-1 fixed bg-[#ffffff] border-[#dfeaf2] w-[20vw] overflow-x-scroll no-scrollbar h-[100vh] inter text-[15px] p-5">
          <Image
            src={logo2}
            alt="Logo"
            className="lg:w-[15vw] lg:h-[9vh] rounded-bl-3xl"
          />
